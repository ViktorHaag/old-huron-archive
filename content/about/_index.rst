...
.. class:: fullwidth
   ...
   **b-side**. I've modified his theme code for this site, but I started with
   ...
   It leans most heavily on the `tufte-css
   <https://github.com/edwardtufte/tufte-css>`_ project with `Gill Sans
   <https://en.wikipedia.org/wiki/Gill_Sans>`_ as the underlying typeface,
   instead of ETBembo.
