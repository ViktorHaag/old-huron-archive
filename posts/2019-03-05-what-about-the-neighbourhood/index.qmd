---
title: "What about the neighbourhood?"
description: "Giving meaningful hooks to Traveller characters means having a
selection of patrons, rumours, and information about not just the system the
characters are currently in, but also the neighbouring systems. Where do the
players want to go next? Where will they get money from? Knowing what lies just
beyond the jump threshold helps facilitate these choices."
date: 2019-03-05
categories: [rpg, traveller, prep]
draft: false
---

Having decided that our player group should start on the
[world of Edgware](../2019-02-25-fleshing-out-a-world/index.qmd)
within the
[Barbican subsector](../2018-12-29-building-a-subsector/index.qmd),
and having one session of play under our belt that
boiled down to the player sgetting used to one anothers' characters and the
sketched out facts about their current situation, it makes sense for me to turn
my attention to where the players might choose to go next. Keeping in mind that
hewing to minimal prep is a factor, we really want to just be laying track right
in front of the train. Where might the players be going right away, in the next
session or two.

::: {.column-margin}
[![neighbouring stars, ESO](https://upload.wikimedia.org/wikipedia/commons/thumb/2/27/Flying_among_the_closest_stars_to_the_Solar_System.ogv/1200px--Flying_among_the_closest_stars_to_the_Solar_System.ogv.jpg)](https://www.eso.org/public/videos/eso1404d/)
:::

Knowing that their ship,
[the Garden](../2019-03-01-price-of-a-yacht/index.qmd),
...
Earth-size world, shrouded by a dense, tainted atmosphere, covered in a bit more
water than Earth. Population is order hundreds-of-thousands. The government in
place is a run-of-the-mill civil service bureaucracy. The law-level is unusually
strict, the tech-level is below average.
...
From the [Near Space](https://rpggeek.com/rpgitem/211119/near-space) source of
stellar data, we start with this information about 70 Ophiuchi:
...
- Pick a name for the world; this would require us deciding on what world-naming
  pattern to use for the subsector next to Barbican.

  Earlier we had decided to use subway station names for global cities, so let's
  choose Paris as the global city to provide names for this subsector.

  Starting from that, we pick Concorde as the name for the subsector and Odéon
  as the world name for the 70 Ophiuchi system.

- Fill out the rest of its basic characteristics: starport level, population,
  government type, law level, and tech level. The world has a standard, although
  tainted, atmosphere, and is entirely covered by water.
...
population on this planet is either in individual sub-surface or raft/ship-based
centres affiliated with off-world corporate research or on-world clan-based
tribes of colonists.
...
- Odéon's lawless and non-industrial nature leads one to believe that it's not a
  terribly inviting place to go. Given its generally temperate climate, and its
  water-world status, it's not hard to feel like life on Odéon might be of the
  sort that suits people who would love to spend their lives on a boat.
